...
class SocialGraph:
    ...
    def get_all_social_paths(self, user_id):
        ...
        """
        # dictionary_of_extended_network = {
            # "user_id_of_friend": [ "user_id", "user_id"], # path to this friend
        ...
        while q.size() > 0:
            ...
            f = friend_path[-1]           
            if f not in visited:
                visited[f] = friend_path
                for frend in self.friendships[f]:
                    path = friend_path.copy()              
                    path.append(frend)
                    q.enqueue(path)                  
        return visited
